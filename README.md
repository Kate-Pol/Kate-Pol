...
Our world changing each day, so trying to be on track with the news in tech world, construction, healthy lifestyle, politic etc. About my personality – easy going, have nice sense of humor and hardworking. Throughout my life and career improved well in technical and soft skills. I like fixing and creating things, can use different tools for this. 
...
<div>
  <img src="https://github.com/devicons/devicon/blob/master/icons/python/python-original-wordmark.svg" title="Python" alt="Python" width="25" height="25"/>&nbsp;
